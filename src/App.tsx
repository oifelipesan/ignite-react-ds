...
export function App() {
  return (
    <div className='w-full min-h-screen h-full bg-gray-900 flex flex-col pt-8 pb-12 items-center justify-center text-gray-100'>
      ...
      <footer className='flex flex-col gap-3 items-center mt-8'>
        ...
        <Text
          ...
          className='text-gray-400 underline hover:text-gray-200'
        >
          <a href=''>Não tem uma conta? Crie uma agora!</a>
        </Text>
      </footer>
    </div>
  )
